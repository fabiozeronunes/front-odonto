  ...
  "inline-flex items-center gap-1 rounded-lg px-4 py-2 text-sm font-semibold transition-colors",
  {
    variants: {
      variant: {
        ...
        gradientTeal: "bg-gradient-to-r from-[#04757B] to-[#05D6DD] text-white rounded-lg px-3 py-1.5 text-xs",
        gradientYellow: "bg-gradient-to-r from-[#EDB730] to-[#F0E651] text-[#3b2f00] rounded-lg px-3 py-1.5 text-xs",
