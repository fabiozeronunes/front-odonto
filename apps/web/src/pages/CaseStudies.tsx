...
export function CaseStudies() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">Estudos de caso</h1>
      ...
      {loading ? (
        ...
        <p className="py-20 text-center text-slate-500">Nenhum estudo de caso publicado.</p>
      ) : (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {items.map((cs) => (
            ...
            >
              ...
              <h3 className="mt-3 font-semibold text-slate-900">{cs.title}</h3>
              <p className="mt-1 line-clamp-2 flex-1 text-sm text-slate-500">{cs.description}</p>
