      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <div>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold text-foreground">Minhas especialidades</h2>
          ...
          <div className="rounded-2xl border border-border bg-surface shadow-card">
            <ul className="divide-y divide-border">
              {loading ? (
                ...
                specialties.map((s) => (
                  <li key={s.id} className="flex items-center justify-between gap-2 px-4 py-3 transition-colors hover:bg-muted/50">
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold text-foreground">Minhas tags</h2>
          ...
          <div className="rounded-2xl border border-border bg-surface shadow-card">
            <ul className="divide-y divide-border">
              {loading ? (
                ...
                tags.map((t) => (
                  <li key={t.id} className="flex items-center justify-between gap-2 px-4 py-3 transition-colors hover:bg-muted/50">
