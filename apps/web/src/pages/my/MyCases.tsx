...
export function MyCases() {
  ...
  function startRenameTag(tag: TagType) {
  ...
  async function createTag(name: string) {
    ...
    try {
      const res = await api<{ data: TagType }>("/api/tags", {
        method: "POST",
    ...
    <div>
      ...
      {editing && (
        <div className="mb-6 space-y-4">
          ...
          {/* Block 3: Áudio, Descrição, Diagnóstico, Observações */}
          <div className="rounded-2xl border border-border bg-surface p-5 shadow-card">
            <BlockHeader icon={Music} title="Áudio e descrição" subtitle="Grave, importe áudio e descreva o caso" />
            <div className="space-y-4">
              ...
              {editing.audioUrl && (
                <div className="space-y-3 rounded-xl border border-primary-100 bg-primary-50/50 p-4 dark:border-primary-800 dark:bg-primary-950/50">
