export function Legal({ type }: { type: "privacidade" | "termos" }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <div className="prose mt-8 space-y-6 text-slate-600">
        {isPrivacy ? (
          <>
            <section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">2. Finalidade</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">3. Seus direitos (LGPD)</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">4. Segurança</h2>
              <p className="mt-2">
          ...
          <>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">2. Conta</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">3. Planos e assinaturas</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">4. Conteúdo</h2>
              <p className="mt-2">
