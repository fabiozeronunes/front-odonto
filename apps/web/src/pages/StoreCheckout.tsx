  ...
  if (done) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-20 text-center sm:px-6">
        <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-900/40">
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      <div className="text-center">
        <span className="inline-flex items-center gap-1.5 rounded-full bg-primary-100 px-3 py-1 text-xs font-semibold text-primary-800 dark:bg-primary-900 dark:text-primary-200">
        ...
        <p className="mt-2 text-muted-foreground">Confirme os itens do Shop Odontus para concluir seu pedido.</p>
      </div>
            ...
            {items.length === 0 ? (
              ...
              items.map((item) => (
                <div key={item.productId} className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold text-foreground">{formatPrice((item.promoPrice ?? item.price) * item.quantity)}</span>
                </div>
              ))
            )}
